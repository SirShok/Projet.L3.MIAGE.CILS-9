...
public class Narration {
	...
	public static String apparitionMonstre(String Ind, Monstre m) {
		String res =null;
		res = ("Malheur !! Un terrible danger se dresse sur votre route vers la Terre Sainte ! Un "+m.Nom+" souhaite en découdre avec vous. \n Aux armes, triompher de cet adversaire sans attendre !!!");
		return res;
	}
	public static String afficheCompetenceMonstre(String Ind, String c,int degat) {
		String res = null;
		res = ("Mince ! Le monstre attaque et inflige "+degat+" de dégats à notre héro !");
		return res;
	}
}
